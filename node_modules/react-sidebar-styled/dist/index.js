...
var propTypes$1 = {
  side: propTypes.PropTypes.oneOf(['left', 'right']),
  speed: propTypes.PropTypes.number,
  timing: propTypes.PropTypes.string,
  overlay: propTypes.PropTypes.bool,
  icons: propTypes.PropTypes.arrayOf(propTypes.PropTypes.func)
};
var defaultProps = {
  side: 'left',
  speed: 500,
  ...
  overlay: true,
  icons: [function () {
    return React__default.createElement(CloseIcon, null);
  }, function () {
    return React__default.createElement(OpenIcon, null);
  }]
};
        ...
        return React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              React__default.createElement('div', { className: 'sidebar__overlay', onClick: this.toggleMenu })
            )
          )
        );
      }
...
exports.diverge = _diverge;
exports.fall = _fall;
exports.grow = _grow;
exports.press = _press;
exports.push = _push;
exports.reveal = _reveal;
exports.shrink = _shrink;
exports.slide = _slide;
exports.uncover = _uncover;
